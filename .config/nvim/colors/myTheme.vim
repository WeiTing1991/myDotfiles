...
let s:sblue  = ['#31748f', 67] "changed
let s:yellow = ['Yellow', 226]
let s:red    = ['#b6403a', 160]
let s:green  = ['#478226', 28]

"get extend color
let s:Surface = ['#1f1d2e', 255]
let s:Overlay = ['#26233a', 255]
let s:Muted = ['#6e6a86	', 255]
let s:Subtle = ['#908caa', 255]
let s:Text = ['#e0def4', 255]
let s:Love = ['#eb6f92', 255]
let s:Gold = ['#f6c177', 255]
let s:Rose = ['#ebbcba', 255]
let s:Pine = ['#31748f', 255]
let s:Foam = ['#9ccfd8', 255]
let s:Iris = ['#c4a7e7', 255]
let s:Highlight_Low = ['#21202e', 255]
let s:Highlight_Med = ['#403d52', 255]
let s:Highlight_High = ['#524f67', 255]
...
call s:hi('CursorLine', s:default_lst, s:Highlight_Med, s:none)
