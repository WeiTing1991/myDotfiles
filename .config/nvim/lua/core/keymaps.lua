...
-- Parser info
vim.keymap.set("n", "<leader><F2>", ":InspectTree<CR>", { desc = "Show the Inspect Tree" })

-- clear search highlights
vim.keymap.set("n", "<leader>zz", ":nohl<CR>", { desc = "Clear search highlights" })

-- Directory Naigation
--vim.keymap.set("n", "<leader>m", ":NvimTreeFocus<CR>", { desc = "Move selection down" })
--vim.keymap.set("n", "<leader>e", ":NvimTreeToggle<CR>", { desc = "Move selection down" })
