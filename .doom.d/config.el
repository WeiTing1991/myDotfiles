...
(cond
  ...
  ((eq system-type 'darwin)  ;; 'darwin' is for macOS
   (setq wt/default-font-size 14)
   (setq wt/default-variable-font-size 12)
   (setq wt/frame-transparency '(85 . 90))
   )
  ;; Windows configuration
  ((eq system-type 'windows-nt)  ;; 'windows-nt' is for Windows
   (setq  wt/default-font-size 10)
   (setq  wt/default-variable-font-size 8)
   (setq  wt/frame-transparency '(95 . 90))
   )
  )

;; Set the font
(setq doom-font (font-spec :family "Hack Nerd Font" :size wt/default-font-size))
(setq doom-font "Terminus (TTF):pixelsize=14:antialias=off")
(setq doom-font "Hack Nerd Font-14")
